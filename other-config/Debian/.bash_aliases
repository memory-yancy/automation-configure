...
alias la="ls -a"
alias os-update="sudo apt-get update"
alias os-upgrade="sudo apt-get upgrade -y"
...
alias os-install='install_app(){ sudo apt-get install -y "$1"; unset -f os-install; }; install_app'
